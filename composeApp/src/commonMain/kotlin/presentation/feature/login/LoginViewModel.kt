...
import presentation.feature.profile.ProfileUiState


class LoginViewModel(
    val service: GithubServiceImpl
): ScreenModel {
    private val _profileUiState = MutableStateFlow(ProfileUiState())
    val profileUiState = _profileUiState.asStateFlow()

    fun getProfileData(userName: String) = CoroutineScope(Dispatchers.IO).launch {
